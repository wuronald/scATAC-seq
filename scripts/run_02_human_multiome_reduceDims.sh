#!/bin/bash
#SBATCH --job-name=run_02_human_multiome_reduceDims
#SBATCH --output=run_02_human_multiome_reduceDims_%j.out
#SBATCH --error=run_02_human_multiome_reduceDims_%j.err
...
# Load the project
projMulti2  <- loadArchRProject(path = "human_multiome")
...
plotPDF(p1,p2,p3,p,
        name = "human_multiome-scATAC-scRNA-Combined.pdf", 
...
plotPDF(p_atac_rna,
        name = "human_multiome-scATAC-scRNA-Combined_ConfusionMatrix.pdf", 
        ArchRProj = projMulti2, # PDF saved in the plots subfolder in the associated project directory
        addDOC = TRUE, # adds date of creation to end of filename
        width = 5, height = 5)
...
colorBy = "cellColData", name = "Sample")
plotPDF(p4,p5,p6,
        name = "human_multiome-scATAC-scRNA-colorby-Sample.pdf", 
        ArchRProj = projMulti2, # PDF saved in the plots subfolder in the associated project directory
        addDOC = TRUE, # adds date of creation to end of filename
        width = 5, height = 5)
