#!/bin/bash
#SBATCH --job-name=run_03_terekhanova_AUCell
#SBATCH --output=run_03_terekhanova_AUCell_%j.out
#SBATCH --error=run_03_terekhanova_AUCell_%j.err
...
if (!exists("exprMatrix")) {
  ...
  if (file.exists("Terekhanova/AUCell/TerekhanovaExprMatrix.RData")) {
  	print("previously saved exprMatrix loaded")
    load(file = "Terekhanova/AUCell/TerekhanovaExprMatrix.RData")
  }
else{
