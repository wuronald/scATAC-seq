#!/bin/bash
#SBATCH --job-name=run_08_human_multiome_chromVarDeviations
#SBATCH --output=run_08_human_multiome_chromVarDeviations_%j.out
#SBATCH --error=run_08_human_multiome_chromVarDeviations_%j.err
