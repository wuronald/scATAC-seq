...
Potential Solutions:
1. update/install `irlba` and `matrix` packages. [github](https://github.com/satijalab/seurat/issues/8100)
...
Another issue with compilation of the Matrix package:
...
+ potential [solution](https://medium.com/biosyntax/following-up-library-dependency-when-compiling-r-packages-89f191b9f227)
